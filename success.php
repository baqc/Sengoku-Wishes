            ...
            <div class="am-u-sm-11 am-u-sm-centered">
                <div class="am-cf am-article">
                    ...
                    <text class="am-kai">
                        ...
                        <li>
                            <?php
                            $myurl=("$url1/$template/case.php?id=$id");
                            ?>
                            你的专属链接为:
                            <a href="<?=$myurl?>">
                                <?=$myurl?></a></li>
                        <li>
                            分享到:
                            <p>
                                <a href="http://connect.qq.com/widget/shareqq/index.html?url=<?=$myurl?>&sharesource=qzone&title=<?=$row[title]?> - by <?=$row[fromname]?>&pics=https://www.lings.cc/images/myurl.jpg&summary=<?=$row[toname]?>，<?=$row[content]?>">
                                    <span class="am-icon-qq">QQ</span></a>
                                <p>
                    </ul>
                ...
                <hr/>
<iframe frameborder="no" border="0" marginwidth="0" marginheight="0" width=298 height=52 src="//music.163.com/outchain/player?type=2&id=740558&auto=1&height=32"></iframe>
            </div>
        </div>
    </div>
...
<body style="background:url('./images/success.png');">
<!--[if lt IE 9]>
